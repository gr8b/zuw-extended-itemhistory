...
class ExtendedItemHistory_CWidgetItemHistory extends CWidget {
			...
			return new Promise((resolve, reject) => {
				...
				.then(binary_data => {
					...
					switch (binary_data.type) {
						case ExtendedItemHistory_CWidgetItemHistory.VALUE_TYPE_IMAGE:
						...
						case ExtendedItemHistory_CWidgetItemHistory.VALUE_TYPE_RAW:
							this.#makeBinaryButton(buttons, binary_data);
							break;
